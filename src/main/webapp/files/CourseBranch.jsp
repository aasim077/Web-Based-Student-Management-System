                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()"  method="post">
                               <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right"> Course ID</label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="cid" id="cid">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">Course Name</label>
                                    <div class="col-md-6">
 ...
 <script type="text/javascript">
    $(function(){
    	$("#save").on('click',function(){
    		...
    		$.ajax({url:"course&branch.jsp",type:"POST",
    			"data":str,
    			  "processData":false,
			...
			success:function(res){
				...
				//alert("s"+res.message);
    				$("#result").html("Data Saved :"+res.status);

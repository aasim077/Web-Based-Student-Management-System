    ...
    <a href="AddNewStudent.jsp"class="w3-bar-item w3-button tablink w3-red" onclick="openCity(event,'London')">Add New Student</a>
      ...
      <a href="branch.jsp"class="w3-bar-item w3-button tablink w3-red" onclick="openCity(event,'London')">Add New Branch</a>
       ...
       <a href="adminLogin.html" class="w3-bar-item w3-button tablink" onclick="openCity(event,'Paris')">Insert New Result  </a> 
        <a href="adminLogin.html"class="w3-bar-item w3-button tablink w3-red" onclick="openCity(event,'London')">Modify Student</a>
        <a href="adminLogin.html"class="w3-bar-item w3-button tablink w3-red" onclick="openCity(event,'London')">Modify Result</a>
    
      <a href="adminLogin.html" class="w3-bar-item w3-button tablink" onclick="openCity(event,'Tokyo')">Registered Students  </a> 
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="success1.jsp" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                         <select  class="form-control" name="bname" id="cname">

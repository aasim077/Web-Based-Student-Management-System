                            ...
                            <form name="my-form" onsubmit="return validform()" method="post">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type= text id=email name=email  class="form-control" name="" required>
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type= text id=mobile name=mobile  class="form-control" name="" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                       <textarea id=address name=address  class="form-control" name="" required></textarea>
                                    </div>
                                </div>
...
$("#save").on('click',function(){
	...
	$.ajax({url:"AddNewStudentAction.jsp",type:"POST",
		"data":str,
		  "processData":false,
		  "contentType":"application/json",
	success:function(res){

...
String sql1="insert into course values('"+cmp.getCourseid()+"','"+cmp.getCname()+"')" ;
...
int n =st.executeUpdate(sql1);
	...
	if(n>0 ){
		...
		jobj.addProperty("message","Course :"+cmp.getCname()+"  saved.");
	}else{
		jobj.addProperty("status","failed");
		jobj.addProperty("message","Course :"+" not saved.");
	}
	}
catch(Exception ex){
